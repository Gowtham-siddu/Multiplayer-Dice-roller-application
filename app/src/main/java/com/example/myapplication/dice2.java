...
public class dice2 extends AppCompatActivity {
    TextView t1,t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1 = (TextView) findViewById(R.id.result21);
        t2 = (TextView) findViewById(R.id.result22);
        ...
        imageview1 = findViewById(R.id.dice21);
        imageview2 = findViewById(R.id.dice22);
